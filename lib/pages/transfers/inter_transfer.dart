      ...
      body: SafeArea(
        child: Column(
          ...
          Padding(
            ...
            SizedBox(height: Dimensions.height30,),
            AppTextField(
                textEditingController: context.read<HomeController>().receive_account,
            ...
            Row(
              ...
              children: [
                ContainerWidget(
                    widget: Text(Constant.RECEIVERBANK, style: TextStyle(color: AppColors.BLACK),),
                    color: AppColors.WHITE, width: Dimensions.width40 * 17, height: Dimensions.height40 * 1.3),
              ],
            ),
            SizedBox(height: Dimensions.height10,),
            AppTextField(
